...
export const Header: React.FC<HeaderProps> = ({ username, onLogout, transactions }) => {
        ...
        <div className="row mt-3">
          <div className="col-md-12">
            ...
            <span className="h5 mb-0 fw-bold ms-2">
              {totalBalance >= 0
                ? <span className="text-success">{formatCurrency(totalBalance)}</span>
                : <span className="text-danger">-{formatCurrency(-totalBalance)}</span>
              }
            </span>
          </div>
